...
#### How to run:
Generate Data based on yfinance: python preprocess_hybrid_tft_dataset.py --universe_csv DataPrepare.csv --freq MIX --lookback 5 --horizon 2 --out_dir data_hybrid_MIX
Perform Training in my report: python train_hybrid_tft.py --data_dir data_hybrid_MIX --model_dir model_hybrid_tft --epochs 200 --batch_size 64 --lr 1e-3
Predict 7 companies and plot the prediction result v.s. Ground truth: python test_forecast_companies_rolling_skip.py --data_dir data_hybrid_MIX --model_dir model_hybrid_tft --tickers 0700.HK,9988.HK,GOOG,JPM,MSFT,VWAGY,XOM --seed_points 4 --use_step 1 --out_dir rolling_results_skip --plot_dir rolling_figures_skip --skip_missing_periods
...
### Key Notes
- **Deprecated**: `Version1_not_used` (2025/11/23 commit) – do not use
- **Primary References**: 
